...
// Project-evaluations scripts: Node-side CLIs, narrower ruleset (allow console, any-typed JSON).
const evalScriptsConfig = {
  ...evalConfig,
  files: ["project-evaluations/scripts/**/*.ts"],
  languageOptions: { ...evalConfig.languageOptions, globals: globals.node },
  rules: {
    ...evalConfig.rules,
    "no-console": "off",
